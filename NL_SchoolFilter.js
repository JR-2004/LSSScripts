...
// @updateURL https://raw.githubusercontent.com/JR-2004/LSSScripts/main/NL_SchoolFilter.js
// ==/UserScript==
...
(function () {
  ...
  function filterTableRows(tableId, startsWith) {
    ...
    for (let i = 0; i < rows.length; i++) {
      ...
      if (row.innerText.startsWith("Opleidingen")) {
        continue;
      }
  ...
  function addFilterButtonGroup() {
    ...
    buttonGroup.appendChild(createFilterButton("Brandweer"));
    buttonGroup.appendChild(createFilterButton("Ambulance"));
    buttonGroup.appendChild(createFilterButton("Politie"));
    buttonGroup.appendChild(createFilterButton("Waterredding"));
  ...
  function placeTablesOnTabs() {
    ...
    aOwn.innerText = "Opleidingen met eigen deelnemers ";
    ...
    aOpen.innerText = "Openstaande opleidingen ";
